...
public:
	...
	SubHandle subscribe(const function<void(TaskContext&)>&, interval_t desiredInterval, SubType type, float timescale, ThreadPool* pool); //Temporary last param for testing. use core interface later!
};
