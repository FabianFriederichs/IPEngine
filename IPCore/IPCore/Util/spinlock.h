...
class alignas(CACHE_LINE_SIZE) BasicSpinLock
{
private:
	alignas(CACHE_LINE_SIZE) std::atomic_flag lck = ATOMIC_FLAG_INIT;
...
class alignas(CACHE_LINE_SIZE) YieldingSpinLock
{
private:
	alignas(CACHE_LINE_SIZE) std::atomic_flag lck = ATOMIC_FLAG_INIT;
...
class alignas(CACHE_LINE_SIZE)TTASSpinLock
{
private:
	alignas(CACHE_LINE_SIZE)std::atomic<bool> lck;
