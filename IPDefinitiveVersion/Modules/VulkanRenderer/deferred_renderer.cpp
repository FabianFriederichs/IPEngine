...
void DeferredRenderer::loadAndPrepareAssets()
{
	...
	// Skybox
	std::string skyboxFileName = "../Assets/happyrenderer/models/sky_sphere.obj";
	...
	for (size_t i = 0; i < m_scene.meshes.size(); ++i)
	{
		...
		std::string modelFileName = "../Assets/happyrenderer/models/" + name + ".obj";
		std::string albedoMapName = "../Assets/happyrenderer/textures/" + name + "/A.dds";
		std::string normalMapName = "../Assets/happyrenderer/textures/" + name + "/N.dds";
		std::string roughnessMapName = "../Assets/happyrenderer/textures/" + name + "/R.dds";
		std::string metalnessMapName = "../Assets/happyrenderer/textures/" + name + "/M.dds";
		std::string aoMapName = "../Assets/happyrenderer/textures/" + name + "/AO.dds";
		if (!fileExist(aoMapName))
		{
			aoMapName = "";
		}
		std::string emissiveMapName = "../Assets/happyrenderer/textures/" + name + "/E.dds";
...
{
	const uint32_t maxSetCount = 128*2+1;
...
{
	const std::string csFileName = "../Assets/happyrenderer/shaders/brdf_lut_pass/brdf_lut.comp.spv";
...
void DeferredRenderer::createSpecEnvPrefilterPipeline()
{
	...
	const std::string vsFileName = "../Assets/happyrenderer/shaders/env_prefilter_pass/env_prefilter.vert.spv";
	const std::string gsFileName = "../Assets/happyrenderer/shaders/env_prefilter_pass/env_prefilter.geom.spv";
	const std::string fsFileName = "../Assets/happyrenderer/shaders/env_prefilter_pass/spec_env_prefilter.frag.spv";
...
void DeferredRenderer::createSkyboxPipeline()
{
	...
	const std::string vsFileName = "../Assets/happyrenderer/shaders/geom_pass/skybox.vert.spv";
	const std::string fsFileName = "../Assets/happyrenderer/shaders/geom_pass/skybox.frag.spv";
...
void DeferredRenderer::createStaticMeshPipeline()
{
	...
	const std::string vsFileName = "../Assets/happyrenderer/shaders/geom_pass/geom.vert.spv";
	const std::string fsFileName = "../Assets/happyrenderer/shaders/geom_pass/geom.frag.spv";
...
void DeferredRenderer::createShadowPassPipeline()
{
	...
	const std::string vsFileName = "../Assets/happyrenderer/shaders/shadow_pass/shadow.vert.spv";
...
void DeferredRenderer::createLightingPassPipeline()
{
	...
	const std::string vsFileName = "../Assets/happyrenderer/shaders/fullscreen.vert.spv";
	const std::string fsFileName = "../Assets/happyrenderer/shaders/lighting_pass/lighting.frag.spv";
...
void DeferredRenderer::createBloomPipelines()
{
	...
	const std::string vsFileName = "../Assets/happyrenderer/shaders/fullscreen.vert.spv";
	const std::string fsFileName1 = "../Assets/happyrenderer/shaders/bloom_pass/brightness_mask.frag.spv";
	const std::string fsFileName2 = "../Assets/happyrenderer/shaders/bloom_pass/gaussian_blur.frag.spv";
	const std::string fsFileName3 = "../Assets/happyrenderer/shaders/bloom_pass/merge.frag.spv";
...
void DeferredRenderer::createFinalOutputPassPipeline()
{
	...
	const std::string vsFileName = "../Assets/happyrenderer/shaders/fullscreen.vert.spv";
	const std::string fsFileName = "../Assets/happyrenderer/shaders/final_output_pass/final_output.frag.spv";
