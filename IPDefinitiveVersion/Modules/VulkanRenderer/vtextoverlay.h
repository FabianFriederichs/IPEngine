#ifndef VTEXTOVERLAY_H
#define VTEXTOVERLAY_H
...
private:
	...
	{
		const std::string vsFileName = "../assets/happyrenderer/shaders/text_pass/text.vert.spv";
		const std::string fsFileName = "../assets/happyrenderer/shaders/text_pass/text.frag.spv";
