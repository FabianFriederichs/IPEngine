...
#include "IBasicGraphicsContentModule_API.h"
// This class is exported from the Plugin2.dll
class BasicGraphicsContentModule : public IBasicGraphicsContentModule_API {
public:
	BasicGraphicsContentModule(void);
...
extern "C" BOOST_SYMBOL_EXPORT BasicGraphicsContentModule module;
BasicGraphicsContentModule module;